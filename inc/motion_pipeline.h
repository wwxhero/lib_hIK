...
HIKLIB(bool,			motion_sync_cnn_cross_c)(HMOTIONNODE parent, HMOTIONNODE child, enum CNN type, const char* pairs[][2], int n_pairs);
HIKLIB(bool,			motion_sync_cnn_cross_w)(HMOTIONNODE parent, HMOTIONNODE child, enum CNN type, const wchar_t* pairs[][2], int n_pairs);

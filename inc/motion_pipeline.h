...
HIKLIB(bool,			motion_sync_cnn_cross_c)(HMOTIONNODE from, HMOTIONNODE to, enum CNN type, const char* pairs[][2], int n_pairs, Real p2c_w[3][4]);
HIKLIB(bool,			motion_sync_cnn_cross_w)(HMOTIONNODE from, HMOTIONNODE to, enum CNN type, const wchar_t* pairs[][2], int n_pairs, Real p2c_w[3][4]);

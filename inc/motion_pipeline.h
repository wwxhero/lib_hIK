...
HIKLIB(bool,			motion_sync_cnn_homo)(HMOTIONNODE parent, HMOTIONNODE child);
HIKLIB(bool,			motion_sync_cnn_cross)(HMOTIONNODE parent, HMOTIONNODE child, const char* pairs[][2], int n_pairs);

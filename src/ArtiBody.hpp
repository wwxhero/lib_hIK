...
public:
	...
	static bool Clone_htr(const CArtiBodyNode* src, CArtiBodyNode** dst, const wchar_t* (*matches)[2], bool force_root[], int n_matches, bool src_on_match0, const Eigen::Matrix3r& src2dst_w);
